...
int main(int argc,char *argv[])
{
 ...
 printf("st_ino=%ld,st_mode=%x,st_nlink=%ld,uid_t=%d,gid_t=%d,st_size=%ld,st_mtime=%ld\n",buf.st_ino,buf.st_mode,buf.st_nlink,buf.st_uid,buf.st_gid,buf.st_size,buf.
# 23 "stat.c" 3 4
                                                                                                                                                                   st_mtim.tv_sec
# 23 "stat.c"
                                                                                                                                                                           );
